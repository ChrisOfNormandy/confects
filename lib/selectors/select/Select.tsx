...
export interface SelectProps<T extends OptionType> extends HtmlElementProps<'select'>, ThemeProps {
    options: SelectOption<T>[];
}

export function Select<T extends OptionType>({ options, className, theme, ...props }: Readonly<SelectProps<T>>) {
    return (
