import { DetailedHTMLProps, ButtonHTMLAttributes, InputHTMLAttributes, HTMLAttributes, TextareaHTMLAttributes } from "react";
...
export declare function isInterfaceTypeIterable<T = unknown>(i: T | Iterable<T>): i is Iterable<T>;
